...
namespace OpenRCT2
{
    ...
    public:
        ...
        virtual bool StopRecording(bool discard = false) override
        {
            ...
            NewsItem* news = news_item_add_to_queue_raw(News::Item::Type::Blank, "Replay recording stopped", 0);
            news->SetFlags(News::Item::Flags::HasButton); // Has no subject.
        ...
        virtual bool StopPlayback() override
        {
            ...
            if (_mode == ReplayMode::PLAYING)
            {
                NewsItem* news = news_item_add_to_queue_raw(News::Item::Type::Blank, "Replay playback complete", 0);
                news->SetFlags(News::Item::Flags::HasButton); // Has no subject.
            }

...
loc_69B221:
    ...
    if (PeepFlags & PEEP_FLAGS_TRACKING)
    {
        ...
        {
            NewsItem::AddToQueue(NewsItem::Type::PeepOnRide, STR_PEEP_TRACKING_NOTIFICATION_BOUGHT_X, sprite_index);
        }
    }
    ...
    if (ride_type_has_flag(ride->type, RIDE_TYPE_FLAG_NO_VEHICLES))
    {
        ...
        else
        {
            ...
            if ((ride->current_issues & RIDE_ISSUE_GUESTS_STUCK) == 0 || gCurrentTicks - ride->last_issue_time > 3000)
            {
                ...
                {
                    NewsItem::AddToQueue(NewsItem::Type::Ride, STR_GUESTS_GETTING_STUCK_ON_RIDE, CurrentRide);
                }
            }
...
void Guest::UpdateRideFreeVehicleEnterRide(Ride* ride)
{
    ...
    if (PeepFlags & PEEP_FLAGS_TRACKING)
    {
        ...
        {
            NewsItem::AddToQueue(NewsItem::Type::PeepOnRide, msg_string, sprite_index);
        }
    }
...
void Guest::UpdateRideLeaveExit()
{
    ...
    if (ride != nullptr && (PeepFlags & PEEP_FLAGS_TRACKING))
    {
        ...
        {
            NewsItem::AddToQueue(NewsItem::Type::PeepOnRide, STR_PEEP_TRACKING_LEFT_RIDE_X, sprite_index);
        }
    }

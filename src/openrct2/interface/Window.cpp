    ...
    rct_window* w, int16_t* map_x, int16_t* map_y, int16_t* offset_x, int16_t* offset_y)
{
    ...
    *offset_x = (w->saved_view_x - (centreLoc->x + rebased_x)) * w->viewport->zoom;
    *offset_y = (w->saved_view_y - (centreLoc->y + rebased_y)) * w->viewport->zoom;
}
...
void window_viewport_centre_tile_around_cursor(rct_window* w, int16_t map_x, int16_t map_y, int16_t offset_x, int16_t offset_y)
{
    ...
    w->saved_view_x = centreLoc->x + rebased_x + (offset_x / w->viewport->zoom);
    w->saved_view_y = centreLoc->y + rebased_y + (offset_y / w->viewport->zoom);
}
